...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        ...
        {
            //print to console that number is inside of list
            ...
            else
            {
                ...
                Console.WriteLine($".....These aren't the droids we are looking for");
            }
        }
        ...
        {
            //create method to populate the number array with 50 random numbers 
            //between 0 and 50
